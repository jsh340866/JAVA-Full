 ...
 * </p>
 * <ol>
 * <li>생성자: Socket 의 InputStream/OutputStream 을 BufferedReader/PrintWriter 로 감싸기
 * (UTF-8 명시).</li>
...
public class MessengerHandler implements Runnable {
	...
	public void run() {
		try {
			...
			// TODO 2) readLine() 반복 → null 이 아니면 MessengerServer.broadcast(닉네임 + " : " +
			// line)
	 ...
	 *
	 * <p>
	 * 학생 TODO: out 이 null 이 아니면 println(message) 호출.
	 * </p>
	 */
