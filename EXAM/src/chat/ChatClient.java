 ...
 *
 * <p>
 * ChatClientUI 와 연결되는 비-UI 통신 클래스. 서버에서 받은 메시지는 messageListener 콜백으로 UI 채팅창에
 * 전달된다.
 * </p>
 *
 * <p>
 ...
 * <li>readLoop() 는 이미 구현되어 있음. connect() 에서 이 메서드를 호출하는 Daemon Thread 만 시작하면
 * 됨.</li>
 * </ol>
 *
 * <p>
...
public class ChatClient {
	...
	public void connect(String host, int port, String nickname) throws IOException {
		...
		// TODO 4) running = true; → new Thread(this::readLoop).setDaemon(true) →
		// start()
		// start()
		running = true;
	 ...
	 *
	 * <p>
	 * 이 메서드는 이미 구현되어 있습니다. 학생은 connect() 안에서 이 메서드를 호출하는 Daemon Thread 를 시작하기만 하면
	 * 됩니다.
	 * </p>
	 */
